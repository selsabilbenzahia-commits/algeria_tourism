...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO restaurants (name_en, name_ar, wilaya_id, image, lat, lng) 
            VALUES ('$name_en', '$name_ar', '$wilaya_id', '$image_path', '$lat', '$lng')";

    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('".$texts[$lang]['success_add_rest']."'); window.location='manage_restaurants.php';</script>";
    } else { 
...
<head>
    <meta charset="UTF-8">
    <title><?php echo $texts[$lang]['admin_panel']; ?> | <?php echo $texts[$lang]['add_restaurant_title']; ?></title>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="flex-row">
                    <div class="form-group">
                        <label><?php echo $texts[$lang]['rest_name_en']; ?></label>
                        <input type="text" name="name_en" required placeholder="Skyline Resto">
                    </div>
                    <div class="form-group">
                        <label><?php echo $texts[$lang]['rest_name_ar']; ?></label>
                        <input type="text" name="name_ar" required placeholder="مطعم الأفق">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label><?php echo $texts[$lang]['rest_img']; ?></label>
                    <div class="image-preview-container">
                        <i class="fas fa-utensils" id="upload-icon"></i>
