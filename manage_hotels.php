...
<head>
    <meta charset="UTF-8">
    <title><?php echo $texts[$lang]['admin_panel']; ?> | <?php echo $texts[$lang]['hotel_mgmt']; ?></title>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; font-family:'Cairo',sans-serif; }
        ...
        th { background: #f1f5f9; color: #64748b; padding: 15px; font-size: 14px; }
        td { padding: 15px; border-bottom: 1px solid #f1f5f9; vertical-align: middle; }
        .hotel-img { width: 60px; height: 60px; border-radius: 8px; object-fit: cover; }
...
<body>
    ...
    <div class="main-content">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
            <h1><?php echo $texts[$lang]['hotel_mgmt']; ?></h1>
            <a href="add_hotel.php" class="add-btn"><i class="fas fa-plus"></i> <?php echo $texts[$lang]['add_hotel']; ?></a>
        </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th><?php echo $texts[$lang]['col_hotel_name']; ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src="img/hotels/<?php echo $row['image']; ?>" class="hotel-img" onerror="this.src='images/default.jpg'"></td>
                        <td>
                        ...
                        <td style="color: #64748b; font-size: 13px; direction: ltr;"><?php echo $row['lat'] . ' / ' . $row['lng']; ?></td>
                        <td>
                            <a href="edit_hotel.php?id=<?php echo $row['id']; ?>" class="btn-edit" title="<?php echo ($lang == 'ar') ? 'تعديل' : 'Edit'; ?>"><i class="fas fa-edit"></i></a>
                            <a href="manage_hotels.php?delete=<?php echo $row['id']; ?>" class="btn-delete" title="<?php echo ($lang == 'ar') ? 'حذف' : 'Delete'; ?>" onclick="return confirm('<?php echo $texts[$lang]['confirm_delete']; ?>')"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
